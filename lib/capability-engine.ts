...
const capabilityPatterns: Array<{
  ...
  },
  {
    ...
    terms: ["视频合成", "视频编辑", "视频渲染", "ffmpeg", "moviepy", "remotion", "video composition", "video rendering"],
  ...
  },
  {
    ...
    terms: ["个性化推荐", "用户偏好", "偏好筛选", "忌口", "年龄推荐", "personalized recommendation", "user preference", "personalized ranking"],
