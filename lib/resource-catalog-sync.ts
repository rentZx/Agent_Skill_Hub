...
const curatedGitHubAnchors: CuratedGitHubAnchor[] = [
  ...
  { repository: "plantnet/my.plantnet", displayName: "Pl@ntNet 植物识别 API 示例", localizedDescription: "Pl@ntNet 官方 API 接入示例，演示使用 Node.js、Python、Java、PHP 和 R 上传本地或远程植物图片并获取物种识别结果。", type: "github_plugin", tags: ["plant-identification", "plant-species-recognition", "plant-identification-api", "plantnet-api", "image-upload", "species-classification"] },
  { repository: "plantnet/ai-taxonomist-webcomponent", displayName: "AI Taxonomist 植物识别组件", localizedDescription: "Pl@ntNet 官方可复用 Web Component，提供图片上传、植物物种识别和候选结果交互，可接入 Pl@ntNet API 或自建兼容服务。", verifiedLicense: "MIT", type: "ui_component", tags: ["plant-identification", "plant-species-recognition", "plant-identification-api", "ai-taxonomist", "web-component", "image-upload", "species-classification", "ui"] },
  { repository: "plantnet/PlantNet-300K", displayName: "PlantNet-300K 植物图像数据集", localizedDescription: "Pl@ntNet 官方植物物种识别数据集与训练基准，适合训练、评估和比较植物图像分类模型；它不是可直接调用的线上识别服务。", verifiedLicense: "BSD-2-Clause", type: "github_plugin", tags: ["plant-identification", "plant-species-recognition", "plant-image-dataset", "plant-species-dataset", "species-classification", "deep-learning", "pytorch"] },
  { repository: "danielbrendel/hortusfox-web", displayName: "HortusFox 植物管理系统", localizedDescription: "自托管植物管理与养护系统，包含 Pl@ntNet 植物识别 API 接入、植物档案、任务、日历和提醒，可作为完整产品流程参考。", type: "template_repo", tags: ["plant-management", "plant-identification", "plantnet-api", "plant-care", "self-hosted", "project-template"] },
  { repository: "spMohanty/PlantVillage-Dataset", displayName: "PlantVillage 植物病害数据集", localizedDescription: "面向作物叶片健康与病害分类的开放图像数据集，仅适用于明确的植物病害识别需求，不应作为通用植物物种识别方案。", type: "github_plugin", tags: ["plant-disease-detection", "plant-disease-dataset", "leaf-disease", "crop-disease", "plant-pathology", "image-classification"] }
];
