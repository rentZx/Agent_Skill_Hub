...
const rules: Rule[] = [
  {
    ...
    industry: "AIGC 与数字内容创作",
    projectType: "一站式 AI 短视频生成与编辑工具",
    targetUsers: "短视频创作者、营销团队、电商运营和自媒体工作者",
    features: [
      "根据主题或文案生成分镜脚本",
      "检索或生成可商用的视频与图片素材",
      "生成配音、背景音乐和时间轴",
  ...
  { terms: ["做饭", "菜谱", "食谱", "食材", "菜品", "忌口", "吃什么", "备菜", "烹饪", "饭菜", "料理"], industry: "餐饮、家庭与营养健康", projectType: "个性化菜谱推荐 Web 应用", targetUsers: "家庭用户、不同年龄段用餐者和有忌口或过敏限制的人群", features: ["根据现有食材检索和推荐菜品", "按用餐人数换算食材用量", "按年龄、营养目标和用餐场景推荐菜品", "过滤忌口、过敏原和饮食偏好", "展示备菜清单与分步骤制作过程", "收藏菜谱、规划菜单和生成购物清单"] },
