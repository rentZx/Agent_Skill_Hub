...
4. Publish a privacy notice explaining that project descriptions may be sent to DeepSeek and that capability searches may be sent to GitHub.
...
- Do not expose `SUPABASE_SERVICE_ROLE_KEY`, `GITHUB_TOKEN`, `DEEPSEEK_API_KEY`, or `DATABASE_URL` to client components.
